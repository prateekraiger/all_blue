...
function renderMarkdown(text: string) {
  ...
  lines.forEach((line, lineIdx) => {
    ...
    while ((match = regex.exec(line)) !== null) {
      ...
      if (match[2]) {
        parts.push(
          <strong key={`b-${lineIdx}-${match.index}`} className="font-medium">
            {match[2]}
          </strong>,
        );
      } else if (match[3]) {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{
              boxShadow:
                "0 0 0 1px #E5E5E5, 0 20px 60px -10px rgba(0,0,0,0.15)",
            }}
          >
            {/* Header */}
            ...
            >
                        ...
                        {msg.products.slice(0, 4).map((product) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p
                                className="text-[12px] font-medium text-[#111111] truncate group-hover:underline"
                                style={{
                                  fontFamily:
                                    '"Helvetica Neue", Helvetica, Arial, sans-serif',
                                }}
              ...
              {isLoading && (
                ...
                >
                  <div
                    className="bg-white px-4 py-3 rounded-[20px] rounded-bl-[4px] flex items-center gap-2"
                    style={{ boxShadow: "0 0 0 1px #E5E5E5" }}
                  >
                    <div className="flex gap-1">
                      <span
                        className="w-1.5 h-1.5 bg-[#707072] rounded-full animate-bounce"
                    ...
                    <span
                      className="text-[11px] text-[#707072] ml-1"
                      style={{
                        fontFamily:
                          '"Helvetica Neue", Helvetica, Arial, sans-serif',
                      }}
